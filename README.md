...
####ОТВЕТ
##1. Создаем VM на yandex Cloud
Для создания VM используем материал предыдущих лекций. [Terraform](https://github.com/htment/TERRAFORM_Y_Cloud)

``
 terraform apply
``
![terr](./img/terraform_apply1.png)
## 2. Строим график
![graf](./img/График_мониторинга.png)
## 3. сохданяем дашборды
![dash](./img/Dasboards.png)